...
//        [self addButtonWithIcon:nil highIcon:nil tag:HMComposeToolbarButtonTypeMention];
//        [self addButtonWithIcon:nil highIcon:nil tag:HMComposeToolbarButtonTypeTrend];
